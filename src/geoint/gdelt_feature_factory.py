...
class gdelt_feature_factory(object):
    """Creates features using GDELT event records.
    """

    def __init__(self):
        pass

    def create_feature(self, gdelt_event):
        """Creates a feature using a GDELT event record.
        """
